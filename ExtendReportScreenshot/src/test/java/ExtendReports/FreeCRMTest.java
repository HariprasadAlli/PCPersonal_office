...
public class FreeCRMTest {
	...
	public void setExtent() {
		...
		extent.addSystemInfo("Host Name", "Hari Prasad Alli");
	...
	public class TestSuite {
		...
		@Test
		public void runFreeCrmTests() {
			FreeCRMTest freeCRMTest = new FreeCRMTest();

			// Call the setup method before running the tests
			freeCRMTest.setup();

			// Call the test methods
			freeCRMTest.freeCrmTitleTest();
			freeCRMTest.freemCRMLogoTest();

			// Call the tearDown method after running the tests
			// Pass null or any dummy ITestResult since it's not used in tearDown
		}
	}
